...
Static marketing site for Wyeth Roofing Limited (Berkshire, Hampshire and Surrey roofers).
...
The 40 MB binary is git-ignored, so download it once per machine:
...
- Confirm opening hours in the JSON-LD (`index.html`); currently Mon to Sat, 08:00 to 18:00.
